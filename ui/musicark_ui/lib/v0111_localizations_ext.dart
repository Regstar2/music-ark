...
extension V0111Localizations on AppLocalizations {
  ...
  String get v0111FolderNotRequired =>
      _ru ? 'не выбрана / не требуется для этого плана' : 'not selected / not required for this plan';

  String v0111Selected(int count) => _ru ? 'Выбрано: $count' : 'Selected: $count';
  String get v0111SelectAllVisible => _ru ? 'Выбрать все видимые' : 'Select all visible';
  String get v0111ClearSelection => _ru ? 'Снять выбор' : 'Clear selection';
  String get v0111UploadToYandex => _ru ? 'Загрузить в Яндекс Музыку' : 'Upload to Yandex Music';
  String v0111BulkUploadTitle(int count) =>
      _ru ? 'Загрузить $count треков в Яндекс Музыку' : 'Upload $count tracks to Yandex Music';
  ...
  String get v0111TargetPlaylist => _ru ? 'Целевой плейлист' : 'Target playlist';
  ...
  String get v0111CancelRemaining => _ru ? 'Отменить оставшиеся' : 'Cancel remaining';
  String get v0111RetryFailures => _ru ? 'Повторить ошибки' : 'Retry failures';
  String get v0111CheckPlaylist => _ru ? 'Проверить плейлист' : 'Check playlist';
  String get v0111BatchFinished => _ru ? 'Массовая загрузка завершена' : 'Bulk upload finished';
  String get v0111BatchCancelled => _ru ? 'Оставшиеся отменены' : 'Remaining items cancelled';
  String get v0111BatchFailed => _ru ? 'Загрузка завершилась с ошибками' : 'Upload finished with errors';
  String get v0111Verified => _ru ? 'Подтверждено' : 'Verified';
  String get v0111Processing => _ru ? 'Обрабатывается' : 'Processing';
  String get v0111DeliveryUnknown => _ru ? 'Результат не определён' : 'Delivery unknown';
  ...
  String get v0111ManagedPlaylists => _ru ? 'Плейлисты MusicArk' : 'MusicArk playlists';
  String get v0111ManagedConfigured => _ru ? 'Настроен' : 'Configured';
  String get v0111ManagedNotConfigured => _ru ? 'Не настроен' : 'Not configured';
  ...
  String get v0111RecoveryRecoverable => _ru ? 'Можно восстановить' : 'Recoverable';
  String get v0111RecoveryMissingLocal => _ru ? 'Нет локального файла' : 'No local file';
  String get v0111RecoveryNeedsReview => _ru ? 'Требует проверки' : 'Needs review';
  String get v0111YandexUnavailable => _ru ? 'Яндекс: недоступен' : 'Yandex: unavailable';
  String get v0111YandexUnknown => _ru ? 'Яндекс: требует проверки' : 'Yandex: needs review';
  String get v0111LocalFound => _ru ? 'Локальная копия: найдена' : 'Local copy: found';
  String get v0111LocalMissing => _ru ? 'Локальная копия: нет' : 'Local copy: missing';
  String get v0111ReadyToRestore => _ru ? 'Готов к восстановлению' : 'Ready to restore';
  String get v0111NeedsLocalFile => _ru ? 'Требуется локальный файл' : 'Local file required';
  String get v0111SourcePlaylists => _ru ? 'Был в' : 'Was in';

  String get v0111DownloadToLocal => _ru ? 'Скачать локально' : 'Download locally';
  String get v0111UploadToYandexGroup => _ru ? 'Загрузить в Яндекс' : 'Upload to Yandex';
  String get v0111NeedsDecision => _ru ? 'Требует решения' : 'Needs decision';
  String get v0111UnavailableTracks => _ru ? 'Недоступны в Яндекс Музыке' : 'Unavailable in Yandex Music';
  String get v0111Recoverable => _ru ? 'Готовы к восстановлению' : 'Ready to recover';
  String get v0111CensoredTracks => _ru ? 'Цензурированные' : 'Censored';
  String get v0111ReadyToUpload => _ru ? 'Готовы к загрузке' : 'Ready to upload';
